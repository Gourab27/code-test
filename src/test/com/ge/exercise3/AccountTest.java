...
//      System.out.println(checkingAccount.toString());
    ...
    @Test
    public void checkingAccOverdrawTest() {
    	checkingAccount.setBalance(100.0f);
    	checkingAccount.withdraw(200.0f);
    	assertEquals(-100, checkingAccount.getBalance(), 0.01);
    	String response = checkingAccount.withdraw(100.0f);
    	assertEquals("Insufficient Balance", response);
    }
    
    @Test
    public void savingsAccOverdrawTest() {
    	savingsAccount.setBalance(100.0f);
    	String response = savingsAccount.withdraw(105.0f);
    	assertEquals("Insufficient Balance", response);
    }
