...
public class GE90 {
	...
	public double calculateHoursLeftToRebuild() {
		return flightHoursBeforeRebuild - (flightHours % (flightHoursBeforeRebuild * numRebuilds));
	}
	
	public double calculateRemainingServiceLife() {
		return ((flightHoursBeforeRebuild * ( maxNumRebuilds - numRebuilds)) - (flightHours % (flightHoursBeforeRebuild * numRebuilds))); 
	}
